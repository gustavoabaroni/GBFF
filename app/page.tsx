const work = [
  ...
  },
  {
    ...
    number: "08",
    title: "Duna",
    description: "Direção de arte e composição visual para o universo de Duna.",
    href: "https://www.behance.net/gallery/220825305/Duna",
    image: "/previews/behance-duna.png",
    tone: "yellow",
  },
  {
    type: "Behance",
    number: "09",
    title: "As aventuras de Simbad, o marujo",
    description: "Design editorial e ilustração para a aventura clássica.",
    href: "https://www.behance.net/gallery/220700517/As-aventuras-de-Simbad-o-marujo",
    image: "/previews/behance-simbad.png",
    tone: "paper",
  },
  {
    type: "Behance",
    number: "10",
    title: "Banner Utopia",
    description: "Peça digital criada para a comunicação da Utopia.",
    href: "https://www.behance.net/gallery/218305169/Banner-Utopia",
    image: "/previews/behance-banner-utopia.png",
    tone: "black",
  },
  {
    type: "Behance",
    ...
    image: "/previews/behance-pharmacia.png",
    tone: "paper",
  },
  {
    type: "Behance",
    number: "12",
    title: "Utopia Brasil",
    description: "Identidade e desdobramentos visuais para a Utopia Brasil.",
    href: "https://www.behance.net/gallery/218304731/Utopia-Brasil",
    image: "/previews/behance-utopia-brasil.png",
    tone: "yellow",
  },
  {
    type: "Behance",
    number: "13",
    title: "Ixer",
    description: "Sistema visual e aplicações para uma marca de telemedicina.",
    href: "https://www.behance.net/gallery/205043261/Ixer",
    image: "/previews/behance-ixer.jpg",
    tone: "black",
  },
  {
    type: "Behance",
    ...
    description: "Seleção de interfaces e experiências digitais.",
    href: "https://www.behance.net/gallery/192584629/UXUI-projects",
    image: "/previews/behance-ux-ui.png",
    tone: "paper",
  },
  {
    type: "Behance",
    number: "15",
    title: "Ecos de Desolação: Crime e Castigo",
    ...
    image: "/previews/behance-ecos.png",
    tone: "yellow",
  },
];
